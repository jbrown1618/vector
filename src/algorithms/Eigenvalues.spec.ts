...
describe('Eigenvalues', () => {
  describe('eig', () => {
    it('calculates the eigenvalue-eigenvector pairs', () => {
      ...
      const expectedVectors = [
        NumberVector.builder().fromArray([1 / 3, -1 / 3, 1]),
        NumberVector.builder().fromArray([0, -1, 1]),
        NumberVector.builder().fromArray([1 / 2, -1 / 2, 1])
      ];
  ...
  describe('calculateEigenvalues', () => {
    it('calculates the eigenvalues of a 2x2 matrix', () => {
      const A = NumberMatrix.builder().fromArray([[2, 1], [2, 3]]);
      const eigenvalues = calculateEigenvalues(A);
      const expected = NumberVector.builder().fromArray([4, 1]);
  ...
  describe('getEigenvectorForEigenvalue', () => {
    it('gets the eigenvectors for a 2x2 matrix', () => {
      ...
      expect(v1).to.deep.equal(NumberVector.builder().fromArray([1 / 2, 1]));
      expect(v2).to.deep.equal(NumberVector.builder().fromArray([-1, 1]));
    });
    ...
    it('gets the eigenvectors for a 3x3 matrix', () => {
      ...
      const expected1 = NumberVector.builder().fromArray([1 / 3, -1 / 3, 1]);
      const expected2 = NumberVector.builder().fromArray([0, -1, 1]);
      const expected3 = NumberVector.builder().fromArray([1 / 2, -1 / 2, 1]);
