...
describe('RowOperations', () => {
  ...
  describe('multiplyRowByScalar', () => {
    test('returns a new matrix with the correct transformation applied', () => {
      ...
      expect(transformed.toArray()).toStrictEqual([[1, 2, 3], [8, 10, 12], [7, 8, 9]]);
    });
  });
  ...
  describe('addRowToRow', () => {
    test('returns a new matrix with the correct transformation applied', () => {
      ...
      expect(transformed.toArray()).toStrictEqual([[5, 7, 9], [4, 5, 6], [7, 8, 9]]);
    });
  });
  ...
  describe('addScalarMultipleOfRowToRow', () => {
    test('returns a new matrix with the correct transformation applied', () => {
      ...
      expect(transformed.toArray()).toStrictEqual([[1, 2, 3], [25, 29, 33], [7, 8, 9]]);
    });
  });
  ...
  describe('exchangeRows', () => {
    test('returns a new matrix with the correct transformation applied', () => {
      ...
      expect(transformed.toArray()).toStrictEqual([[7, 8, 9], [4, 5, 6], [1, 2, 3]]);
    });
  });

  describe('pivot', () => {
    test('sorts a matrix by the number of leading zeros', () => {
      const unsorted = mat([[0, 5, 5], [5, 5, 5], [0, 0, 5]]);
