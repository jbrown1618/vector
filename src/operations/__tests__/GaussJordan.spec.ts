...
describe('GaussJordan', () => {
  ...
  describe('rowEchelonForm', () => {
    test('row reduces a "wide" matrix', () => {
      ...
      expect(aRef.toArray()).toStrictEqual([[4, 5, 6], [0, 0.75, 1.5]]);
    });
    ...
    test('row reduces a matrix with non-independent rows', () => {
      ...
      const aRef = rowEchelonForm(A);
      expect(aRef).toStrictEqual(mat([[1, 2, 3], [0, -1, -2], [0, 0, 0]]));
      ...
      expect(bRef).toStrictEqual(mat([[-3, 9, 9, 0], [0, 5, 5, 0], [0, 0, 0, 0]]));
    });
    ...
    test('row reduces a matrix with non-diagonal pivot entries', () => {
      ...
      const aRef = rowEchelonForm(A);
      expect(aRef.toArray()).toStrictEqual([[1, 1, 1], [0, 0, 2], [0, 0, 0]]);
    });
  ...
  describe('reducedRowEchelonForm', () => {
    test('row reduces a "wide" matrix', () => {
      ...
      expect(aRef.toArray()).toStrictEqual([[1, 0, -1], [0, 1, 2]]);
    });

    test('row reduces a "tall" matrix', () => {
      const A = mat([[0, 1], [0, 0], [5, 9]]);
      const aRef = reducedRowEchelonForm(A);
      expect(aRef.toArray()).toStrictEqual([[1, 0], [0, 1], [0, 0]]);
    });
    ...
    test('row reduces a matrix with non-independent rows', () => {
      ...
      const aRef = reducedRowEchelonForm(A);
      expect(aRef.toArray()).toStrictEqual([[1, 0, -1], [0, 1, 2], [0, 0, 0]]);
    });
    ...
    test('row reduces a matrix with non-diagonal pivot entries', () => {
      ...
      const aRef = reducedRowEchelonForm(A);
      expect(aRef.toArray()).toStrictEqual([[1, 1, 0], [0, 0, 1], [0, 0, 0]]);
    });
